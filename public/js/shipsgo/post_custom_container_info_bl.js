$(document).ready(function() {    
    ...
    $(document).on("submit", "#postcustomcontainerinfobl_form", function(e) {
        e.preventDefault();

        $.ajax({
            type: "POST", // Default GET
            url: APP_URL + "/api/shipsgo/postcustomcontainerinfobl",
            data: {
            ...
            success: function(data_resp, textStatus, jqXHR) {
                ...
                if (data_resp.status) {
                    ...
                    success_body +=
                        "Custom Container Information Post With BL Inserted successfully.";
                    ...
                    warning_body +=
                        "Custom Container Information With BL Post not Inserted... Please try after sometime. ";
