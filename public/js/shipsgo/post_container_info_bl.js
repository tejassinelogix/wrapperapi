$(document).ready(function() {  
    ...
    $(document).on("submit", "#postcontainerinfobl_form", function(e) {
        e.preventDefault();        
        $.ajax({
            type: "POST", // Default GET
            url: APP_URL + "/api/shipsgo/postcontainerinfobl",
            data: {
            ...
            success: function(data_resp, textStatus, jqXHR) {
                ...
                if (data_resp.status) {
                    ...
                    success_body +=
                        "Container Information Post With BL Inserted successfully.";
                    ...
                    warning_body +=
                        "Container Information With BL Post not Inserted... Please try after sometime. ";
